...
public:
    ...
    /**
     * @brief Fill rectangular area with color (RGB565)
    ...
    /**
     * @brief Fill rectangular area with color (RGB666)
     * @param x0 Start X coordinate
     * @param y0 Start Y coordinate
     * @param x1 End X coordinate
     * @param y1 End Y coordinate
     * @param color666 RGB666 color value
     */
    ...
    /**
     * @brief Fill entire screen with color (RGB666)
     * @param color666 RGB666 color value
     */
...
public:
    ...
    /**
     * @brief Draw a string with pixel scaling (1 = 8×16 cells, 2 = 16×32, …)
     */
    void drawStringScaled(uint16_t x, uint16_t y, const char* str, uint32_t color, uint32_t bg_color, unsigned scale);

    void drawStringScaled(uint16_t x, uint16_t y, std::string_view str, uint32_t color, uint32_t bg_color, unsigned scale);
